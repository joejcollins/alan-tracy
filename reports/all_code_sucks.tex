...
\begin{frame}{What To Do}
  ...
  \note<1>{
    ...
    The initial discovery is to find out how the code is actually used.\\
    Then we can start to explore the code and find it's quirks.\\
    ...
    \vfil
    I skipped taking control of the development environment.\\
    At Zengenti we use ephemeral environments.\\
    But that is whole other talk.
  }
  \note<2>{
    As a demo I have and API with one end point.\\
    Enjoy the squiggles, however, it does run.\\
    \textbf{make app}\\
    ...
    \textbf{demo01log}\\
    Feathers don't change until you have tests,\\
  ...
  \note<3>{
    ...
    \textbf{demo2http01}\\
    There's a Jetbrains client or in this case a VSCode extension.\\
    \textbf{demo2http02}\\
